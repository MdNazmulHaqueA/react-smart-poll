        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                <div className="d-flex">
                    ...
                    <Button type="button" className="ml-2" onClick={() => this.props.deletePoll(this.props.poll.id)}>
                        Delete
                    </Button>
                </div>
                ...
                <FormGroup className="my-3">
                    ...
                    <Input name="name" placeholder="HM Nayem" value={this.state.value} onChange={this.handleChange} invalid={this.state.errors.name ? true : false} />
